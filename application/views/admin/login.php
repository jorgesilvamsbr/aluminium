...
<html lang="en">
    ...
    <head>
        ...
        <title>Aluminium Center - Area Administrativa</title>
    ...
    <body>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <img src="<?php echo base_url() . '/img/logo2.png' ?>" class="col-md-offset-4">
        ...
        <script src="<?php echo base_url() . "admin/"; ?>js/jquery-1.11.0.js"></script>

        <!-- Bootstrap Core JavaScript -->
        <script src="<?php echo base_url() . "admin/"; ?>js/bootstrap.min.js"></script>

        <!-- Metis Menu Plugin JavaScript -->
        <script src="<?php echo base_url() . "admin/"; ?>js/plugins/metisMenu/metisMenu.min.js"></script>
